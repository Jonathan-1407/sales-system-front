  ...
  methods: {
    ...
    changeStateConfirm: function() {
      ...
      if (self.editedItem.state) {
        axios
          .put("/sales/sale/cancel", self.editedItem, config)
          .then(() => {
            self.showSnackbar({
              show: true,
              text: "Cancelled Sale",
        ...
        axios
          .put("/sales/sale/approve", self.editedItem, config)
          .then(() => {
            self.showSnackbar({
              show: true,
              text: "Approved Sale",
    ...
    save: function() {
      ...
      axios
        .post("/sales/sale/add", self.editedItem, config)
        .then(() => {
          self.showSnackbar({
            show: true,
            text: "Saved Sale",
